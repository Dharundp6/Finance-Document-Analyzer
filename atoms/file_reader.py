...
class BaseFileReader(ABC):
    ...
    @abstractmethod
    def read(self, file_path: str | Path | BinaryIO) -> dict[str, Any]:
        """Read file and return structured content."""
        pass

    @abstractmethod
    def extract_tables(self, file_path: str | Path | BinaryIO) -> list[dict[str, Any]]:
...
class PDFReader(BaseFileReader):
    ...
    def read(self, file_path: str | Path | BinaryIO) -> dict[str, Any]:
        ...
        try:
            ...
            raise DocumentProcessingError(f"Failed to read PDF: {e}") from e
    ...
    def read(self, file_path: str | Path | BinaryIO) -> dict[str, Any]:
        ...
        try:
            ...
            for table_idx, table in enumerate(doc.tables):
                table_data = {"table_index": table_idx, "headers": [], "rows": []}
...
class ExcelReader(BaseFileReader):
    ...
    def read(self, file_path: str | Path | BinaryIO) -> dict[str, Any]:
        ...
        try:
            ...
            raise DocumentProcessingError(f"Failed to read Excel file: {e}") from e
...
class CSVReader(BaseFileReader):
    ...
    def read(
        ...
        try:
            ...
            raise DocumentProcessingError(f"Failed to read CSV file: {e}") from e
...
class TextReader(BaseFileReader):
    ...
    def read(self, file_path: str | Path | BinaryIO, encoding: str = "utf-8") -> dict[str, Any]:
        """
