...
from core.types import QueryContext, RetrievalResult, FinancialEntity
...
class QueryEngine:
    ...
    QUERY_PATTERNS = {
        ...
        'trend': [
            r'\btrend\b', r'\bover time\b', r'\bgrowth\b',
            r'\bincrease\b', r'\bdecrease\b', r'\bchange\b'
        ],
        'aggregation': [
            r'\btotal\b', r'\bsum\b', r'\baverage\b',
            r'\bcount\b', r'\bhow many\b', r'\bhow much\b'
        ],
        'lookup': [
            r'\bwhat is\b', r'\bwhat was\b', r'\bwhat are\b',
            r'\bshow me\b', r'\bfind\b', r'\blist\b'
        ],
        'analytical': [
            r'\bwhy\b', r'\bexplain\b', r'\banalyze\b',
            r'\bimpact\b', r'\bcause\b', r'\breason\b'
        ]
    }
